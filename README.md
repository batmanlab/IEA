...
We identified two distinct IEAs that capture most of the relationship between CT images and blood gene expression. IEA<sub>emph</sub> captures an emphysema-predominant process with a strong positive correlation to CT emphysema and a negative correlation to FEV1 and Body Mass Index (BMI). IEA<sub>airway</sub> captures an airways-predominant process with a positive correlation to BMI and airway wall thickness and a negative correlation to emphysema. The IEA<sub>airway</sub> was significantly associated with risk of mortality (HR 2.23, CI 1.49-3.35). Both axes showed a positive correlation to the emphysema peel-core distribution, defined as 100 times the logarithm of the ratio of perc15 in the lung periphery to the lung core.
